...
class AppColor {
  ...
  static List<Color> griedentSix = [
    const Color(0XFF157DBC),
    const Color(0XFF5DA4D9),
  ];

  static List<Color> griedentOne = [
    const Color(0XFFFFDC53),
    const Color(0XFFFF9100),
  ];

  static List<Color> griedentTow = [
    const Color(0XFFEDDE5D),
    const Color(0XFFD8C62C),
  ];

  static List<Color> griedentThree = [
    const Color(0XFFDEF2FF),
    const Color(0XFFB6D8FD),
    const Color(0XFF81B5FB)
  ];

  static List<Color> griedentFour = [
    const Color(0XFF14A8AE),
    const Color(0XFF14A8AE)
  ];

  static List<Color> griedentFive = [
