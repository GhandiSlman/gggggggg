...
abstract class ContinuousRatingRepo {
  Future<DataState> getContinuousRating(
      {required ContinuousRating continuousRating});
  Future<DataState> addContinuousRate(
      {required AddContinuousRating addContinuousRating});
  ...
  Future<DataState> addContinuousRateStudent(
      {required AddContinuousRateStudent addContinuousRateStudent});
  Future<DataState> updateContinuousRateStudent(
      {required UpdateContinuousRate updateContinuousRate, required int id});
