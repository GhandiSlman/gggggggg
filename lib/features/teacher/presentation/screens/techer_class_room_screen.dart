            ...
            : TabBarView(
                ...
                children: homeWorkController.myTabs.isEmpty
                    ...
                    : homeWorkController.myTabs.map((tab) {
                        ...
                        //     homeWorkController.homeWorkList[homeWorkController
                        //         .selectedSubject.first]?[tab.text];
                        return
                         homeWorkController.homeWorkList.isEmpty  
                            ...
                            ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  var subject = homeWorkController.homeWorkList[index];
                                  return Padding(
                                    padding: EdgeInsets.all(15.h),
                                    child: SubjectCard(
                                      homeWorkData: homeWorkController.homeWorkList[index],
                                      name: subject.title!,
                                      date: '${subject.endDate}',
                                      id: homeWorkController.homeWorkList[index].id!,
                                    ),
                                  );
                                },
                              );
