...
class ParentChatScreen extends GetView<ChatController> {
      ...
      body: Padding(
        ...
        child: Obx(
          () => !controller.getContactsIsLoading.value
              ? ListView.separated(
                  itemCount: controller.teacherContactsModel!.guardians.length,
                  itemBuilder: (_, index) {
                    return ChatCard(
                      contactModel:
                          controller.teacherContactsModel!.guardians[index],
                    );
                  },
