    ...
    return Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          bottom: PreferredSize(
            preferredSize:  box.read('userType') == 'student'
                ?  Size.fromHeight(25.h) :  Size.fromHeight(50.h), 
            child: box.read('userType') == 'student'
                ? const SizedBox()
                : Obx(() {
        ...
        body: box.read('userType') == 'student'
            ? Obx(() {
